...
MIN_ITV_BETA: float = 2.0                 # Beta minimum interval (Exponential - decay rate)
MAX_ITV_BETA: float = 2.0                 # Beta maximum interval (Exponential - decay rate)
...
MIN_ITV_ETA: float = 0.8                  # Eta minimum interval (Branching ratio)
MAX_ITV_ETA: float = 0.8                  # Eta maximum interval (Branching ratio)
