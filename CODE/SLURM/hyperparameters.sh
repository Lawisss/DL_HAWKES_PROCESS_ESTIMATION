...
# Usage: sbatch "$HOME/Documents/VAE_HAWKES_PROCESS_ESTIMATION/CODE/SLURM/hyperparameters.sh"
...
# Run python script
python "$HOME/Documents/VAE_HAWKES_PROCESS_ESTIMATION/CODE/HAWKES/hyperparameters.py"
